...
export interface ApiFaqCategoryFaqCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    faq_segments: Schema.Attribute.Relation<
      'manyToMany',
      'api::faq-segment.faq-segment'
    >;
...
export interface ApiFaqSegmentFaqSegment extends Struct.CollectionTypeSchema {
  collectionName: 'faq_segments';
  info: {
    description: '';
    displayName: 'faq-segment';
    pluralName: 'faq-segments';
    singularName: 'faq-segment';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiFaqFaq extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    faq_category: Schema.Attribute.Relation<
      ...
      'api::faq-category.faq-category'
    >;
    faq_segment: Schema.Attribute.Relation<
      'manyToOne',
      'api::faq-segment.faq-segment'
    >;
    locale: Schema.Attribute.String;
...
export interface ApiJobSectionJobSection extends Struct.CollectionTypeSchema {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::faq-segment.faq-segment': ApiFaqSegmentFaqSegment;
      'api::faq.faq': ApiFaqFaq;
      'api::global.global': ApiGlobalGlobal;
      'api::job-level.job-level': ApiJobLevelJobLevel;
